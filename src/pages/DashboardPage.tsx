    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">
          Welcome back{selectedCompany?.roleTitle ? `, ${selectedCompany.roleTitle}` : ""}
        </h1>
        <p className="text-sm text-muted">Here's the shape of your work at {selectedCompany?.name}.</p>
      </div>
